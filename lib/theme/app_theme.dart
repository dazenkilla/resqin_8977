...
/// A class that contains all theme configurations for the emergency medical services application.
class AppTheme {
  AppTheme._();

  // Medical Trust Palette - Emergency medical services color system
  static const Color primaryLight =
      Color(0xFFE53E3E); // Emergency red for critical actions
  static const Color primaryVariantLight =
      Color(0xFFC53030); // Darker red variant
  static const Color secondaryLight =
      Color(0xFF3182CE); // Trust blue for secondary actions
  static const Color secondaryVariantLight =
      Color(0xFF2C5282); // Darker blue variant
  static const Color successLight = Color(0xFF38A169); // Confirmation green
  static const Color warningLight = Color(0xFFD69E2E); // Attention amber
  static const Color errorLight =
      Color(0xFFE53E3E); // Consistent with primary for errors
  static const Color backgroundLight =
      Color(0xFFF7FAFC); // Soft neutral background
  static const Color surfaceLight =
      Color(0xFFFFFFFF); // Pure white for content cards
  static const Color textPrimaryLight =
      Color(0xFF1A202C); // High contrast dark text
  static const Color textSecondaryLight =
      Color(0xFF4A5568); // Medium gray for supporting info
  ...
  static const Color primaryVariantDark =
      Color(0xFFE53E3E); // Original red as variant
  static const Color secondaryDark =
      Color(0xFF63B3ED); // Lighter blue for dark theme
  static const Color secondaryVariantDark =
      Color(0xFF3182CE); // Original blue as variant
  ...
  static const Color errorDark =
      Color(0xFFFC8181); // Consistent with primary for errors
  ...
  static const Color borderDark =
      Color(0xFF4A5568); // Darker border for dark theme
  ...
  static const Color shadowLight =
      Color(0x1A000000); // 0.1 opacity for minimal shadows
  static const Color shadowDark =
      Color(0x26000000); // Slightly more visible in dark theme
  ...
  /// Light theme optimized for emergency medical services
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      // Display styles - Inter Bold (700) for maximum impact
      ...
      // Headline styles - Inter SemiBold (600) for clear hierarchy
      ...
      // Title styles - Inter Medium (500) for section headers
      ...
      // Body styles - Inter Regular (400) and Medium (500) for content
      ...
      // Label styles - Inter Medium (500) for buttons and labels
  ...
  /// Data text theme using JetBrains Mono for booking codes, times, and numerical data
